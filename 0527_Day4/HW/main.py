...
def add_to_dict(a, b, c="definition"):
  if type(a) is str:
    ...
    if 'word' in a == False:
      ...
      a = {'word':b, 'definition':c}
      print (f"{b} has been added")
  
      
def get_from_dict(a, b="search"):
  if type(a) is str:
    print ("You need to send a dictionary. You sent <class 'str>")
  elif b == "search":
    ...
    if b in a == True:
      print (f"{b}: {a['definition']}")
    elif b in a == False:
      print (f"{b} was not found in this dict.")
    

def update_word(a, b, c="definition"):
  if type(a) is str:
    print ("You need to send a dictionary. You sent: <class 'str'>")
  elif c == "definition":
    print ("You need to send a word and a definition")
